...
function CustomPromptModal() {
  const { state, togglePromptModal, savePrompt } = usePrompts();
  ...
  const handleSavePrompt = () => {
    if (!promptName.trim() || !promptText.trim()) {
      setError('プロンプト名とプロンプトテキストを入力してください');
      return;
    }
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="例: SEO重視のブログ記事プロンプト"
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <h3 className="font-medium text-blue-800">プロンプトのヒント</h3>
                  <p className="text-sm text-blue-700">
                    効果的なプロンプトには以下の要素を含めることをお勧めします：
                  </p>
